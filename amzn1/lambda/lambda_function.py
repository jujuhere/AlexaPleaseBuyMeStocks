...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Wilkommen! Was wollen sie tun? Aktien kaufen oder verkaufen?"
...
class MarketOrderIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        if (side == "kaufe"):
            ...
            orders.append(order)
            speak_output = "Einkauf erfolgreich getätigt."
            for order in orders:
            ...
            order = requests.post(
             ...
             data={"isin": isin,
              ...
              headers={"Authorization": f"Bearer {<YOUR-API-KEY>}"}).json()
            orders.append(order)
            speak_output = "Verkauf erfolgreich getätigt."
